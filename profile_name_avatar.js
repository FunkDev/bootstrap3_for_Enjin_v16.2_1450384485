...
var avatar_small = $('.element_avatar.tiny img').attr('src');
var avatar_large = avatar_small.replace("tiny", "avatar");

$("#boot_username >a").prepend('<img src="'+avatar_small+'">'+username+'<b class=\"caret\"></b>');
